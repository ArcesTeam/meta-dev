...
<p align="right">
  <a href="https://github.com/ArcesTeam/meta-dev/blob/main/.github/lang/zh-CN/CONTRIBUTING-DEV.md" title="简体中文">CN 简体中文</a> &nbsp;|&nbsp;
...
1. **Read the Development Guide**
   ...
   the [Development Guide & Workflow](https://github.com/ArcesTeam/meta-dev/blob/main/.github/lang/en-US/CONTRIBUTING-GUIDE.md)
...
- If you have questions or need assistance, please contact the maintainers
  via [❓ Question Report](https://github.com/ArcesTeam/meta-dev/issues/new?template=13_Question_Report.yaml)
